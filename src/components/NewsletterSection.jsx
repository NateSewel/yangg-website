  ...
  return (
    <section id="newsletter" className="section-container px-4 md:px-0">
      <motion.div 
        ...
        initial="hidden"
        whileInView="show"
        className="bg-blue-600 dark:bg-blue-700 rounded-2xl overflow-hidden"
      >
        <div className="relative md:px-16 px-6 py-16 md:py-24">
          {/* Background Gradient */}
          <motion.div 
            variants={fadeIn('left', 0.4)}
            className="absolute top-0 right-0 w-1/2 h-full bg-blue-700 dark:bg-blue-800 clip-path-slant hidden md:block"
          ></motion.div>
            ...
            >
              ...
              >
                <motion.input
                  ...
                  className="w-full sm:w-auto md:w-80 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-l-xl sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-green-500 bg-white text-gray-900"
                />
                <motion.button 
