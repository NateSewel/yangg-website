        ...
        <div className="flex justify-between items-center h-14 sm:h-16 md:h-20 gap-2 sm:gap-3">
          ...
          <div className="order-3 flex items-center gap-1 sm:gap-2 flex-shrink-0 z-50">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="hidden lg:block px-3 xl:px-5 py-2 xl:py-2.5 rounded-lg bg-[#32a8ed] text-white hover:bg-[#2a8bc4] text-xs xl:text-sm 2xl:text-base font-medium transition-all hover:shadow-lg hover:shadow-[#32a8ed]/30 cursor-pointer whitespace-nowrap"
            >
              {t("nav.getInTouch")}
            </motion.a>
